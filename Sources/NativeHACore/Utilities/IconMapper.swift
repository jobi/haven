...
public struct IconMapper: Sendable {
    ...
    private static let mdiToSFSymbolMap: [String: SymbolPair] = [
        ...
        // Additional Sensors, Tools & Domains
        "gauge": SymbolPair(normal: "gauge.with.dots.needle.bottom.50percent", active: "gauge.with.dots.needle.bottom.100percent"),
        "water": SymbolPair(normal: "drop", active: "drop.fill"),
        "battery": SymbolPair(normal: "battery.100", active: "battery.100.bolt"),
        "brightness-5": SymbolPair(normal: "sun.max", active: "sun.max.fill"),
        "sine-wave": SymbolPair(normal: "waveform.path.ecg", active: "waveform.path.ecg.rectangle.fill"),
        "current-ac": SymbolPair(normal: "bolt.badge.automatic", active: "bolt.badge.automatic.fill"),
        "lightning-bolt": SymbolPair(normal: "bolt.fill", active: "bolt.fill"),
        "weather-windy": SymbolPair(normal: "wind", active: "wind"),
        "weather-sunny": SymbolPair(normal: "sun.max.fill", active: "sun.max.fill"),
        "weather-partly-cloudy": SymbolPair(normal: "cloud.sun.fill", active: "cloud.sun.fill"),
        "remote": SymbolPair(normal: "tv.and.mediabox", active: "tv.and.mediabox"),
        "form-dropdown": SymbolPair(normal: "filemenu.and.selection", active: "filemenu.and.selection"),
        "palette": SymbolPair(normal: "paintpalette", active: "paintpalette.fill"),
        "robot": SymbolPair(normal: "gearshape.2", active: "gearshape.2.fill"),
        "script-text": SymbolPair(normal: "doc.text", active: "doc.text.fill"),
        "clock-outline": SymbolPair(normal: "clock", active: "clock.fill"),
